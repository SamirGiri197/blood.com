   ...
   <body>
      ...
      <div class="container-fluid bg-danger">
         <div class="row">
               ...
               <h6 class="text-light ">
                  If you want to donate blood you can contact through comment or Direct Message available on blood requests.
               </h6>
               </div>
                  ...
                  <div class="col-md-4 col-sm-12">
                     <div class="card text-center bg-light" style="border: 1px solid;">
                        ...
                        <div class="card-footer  justify-content-between">
                           ...
                           <button class="btn btn-success comment-btn">
                           Comment
                           </button>
                        </div>
                        <div class="comment-section" style="display:none;">
                           <textarea class="form-control mt-2" placeholder="Type your comment here......"
                              rows="1">
                           </textarea>
                           <button class="btn btn-danger mt-3 mb-2" type="submit">
                           Submit
                           </button>
                        </div>
                     </div>
